...
Priebeh odozvy systému na skokovú zmenu výkonu Peltierovho článku je znázornený na obrázku XX.
...
Priebeh odozvy teploty vody v zásobníku na skokovú zmenu výkonu čerpadla je znázornený na obrázku XX.
...
\begin{figure}[h!]
    \centering
    % Sem vloz cestu k tvojmu obrazku s orezanymi datami
    % \includegraphics[width=0.8\textwidth]{obrazky/ident_priebeh.png}
...
\begin{figure}[h!]
    \centering
    % Sem vloz cestu k tvojmu obrazku s porovnanim modelu a dat
    % \includegraphics[width=0.8\textwidth]{obrazky/model_vs_data.png}
...
\begin{figure}[h!]
    \centering
    % \includegraphics[width=0.9\textwidth]{obrazky/simulink_schema.png}
...
\begin{figure}[h!]
    \centering
    % \includegraphics[width=0.8\textwidth]{obrazky/sim_teplota.png}
...
\begin{figure}[h!]
    \centering
    % \includegraphics[width=0.8\textwidth]{obrazky/sim_zasah.png}
